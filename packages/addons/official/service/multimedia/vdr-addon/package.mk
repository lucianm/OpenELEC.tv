...
PKG_URL=""
PKG_DEPENDS_TARGET="toolchain vdr vdr-plugin-vnsiserver vdr-iptv vdr-wirbelscan vdr-wirbelscancontrol vdr-plugin-dvbapi vdr-plugin-streamdev vdr-live vdr-plugin-epgsearch vdr-plugin-xmltv2vdr vdr-plugin-eepg vdr-dummydevice vdr-plugin-satip vdr-plugin-epgfixer vdr-plugin-restfulapi vdr-plugin-amlhddevice"
...
addon() {
  ...
  VDR_PLUGIN_AMLHDDEVICE_DIR="$(get_build_dir vdr-plugin-amlhddevice)"
  ...
  cp -PR $VDR_PLUGIN_AMLHDDEVICE_DIR/libvdr*.so.* $ADDON_BUILD/$PKG_ADDON_ID/plugin
